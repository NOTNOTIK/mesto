export class Card {
  constructor({data, handleDeleteClick, handleCardClick, handleSetLike, handleDeleteLike}, templateSelector, userId ){
    this._data = data;
  ...
  _setEventListeners() {
     this._element.querySelector(".cards__img").addEventListener("click", () => {
      this._handleCardClick({image: this._link, text: this._name})
    });  
